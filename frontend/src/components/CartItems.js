                ...
                <div className='flex flex-col gap-10'>
                    ...
                    <div>
                        <div className='flexBetween py-4'>
                            ...
                            <h4 className='text-gary-30 font-semibold'>${getTotalCartAmount()}</h4>
                        </div>
                        <hr/>
                        <div className='flexBetween py-4'>
                            <h4 className='medium-16'>Shipping Fee:</h4>
                            <h4 className='text-gary-30 font-semibold'>Free</h4>
                        </div>
                        <hr/>
                        <div className='flexBetween py-4'>
                    ...
                    <div className='flex flex-col gap-10'>
                        ...
                        <div className='flexBetween pl-5 h-12 bg-primary rounded-full ring-1 ring-slate-900/10'>
                            <input type="text" placeholder='Coupon code' className='bg-transparent border-none ouline-none'/>
