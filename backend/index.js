...
//Database connection
mongoose.connect("mongodb://localhost:27017/ecommerce-mern")
...
//creating end ponit for registering
...
//creating middlewear fetch user
...
app.post('/addtocart', fetchUser ,async(req,res)=>{
    console.log("Added  the cart", req.body.itemId)
...
app.post('/removefromcart',fetchUser,async(req,res)=>{
    console.log("Remove from the cart", req.body.itemId)
    let userData = await User.findOne({_id: req.user.id})
